...
export const registerClass = (inputs) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      "https://lite-cms-pyfo.onrender.com/api/classes",
      {
        ...inputs,
      },
      {
  ...
  async (dispatch) => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://lite-cms-pyfo.onrender.com/api/classes/title/${title}?page=${page}&size=${size}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const getAllClasses =
  ...
  async (dispatch) => {
    ...
    try {
      dispatch(loading());
      const { data } = await axios.get(
        `https://lite-cms-pyfo.onrender.com/api/classes?page=${page}&size=${size}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const getSingleClass = (id) => async (dispatch) => {
  ...
  try {
    dispatch(loading());
    const { data } = await axios.get(
      `https://lite-cms-pyfo.onrender.com/api/classes/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
export const deleteClasses =
  ...
  async (dispatch) => {
    ...
    try {
      dispatch(loading());
      const { data } = await axios.delete("https://lite-cms-pyfo.onrender.com/api/classes", {
        data: { ids },
        headers: {
          Authorization: `Bearer ${token}`,
        },
