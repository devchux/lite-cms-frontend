...
export const registerEvent = (inputs) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      "https://lite-cms-pyfo.onrender.com/api/events",
      {
        ...inputs,
      },
      {
  ...
  async (dispatch) => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://lite-cms-pyfo.onrender.com/api/events?page=${page}&size=${size}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const getSingleEvent = (id) => async (dispatch) => {
  ...
  try {
    dispatch(loading());
    const { data } = await axios.get(`https://lite-cms-pyfo.onrender.com/api/events/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async (dispatch) => {
    ...
    try {
      ...
      const { data } = await axios.delete(
        `https://lite-cms-pyfo.onrender.com/api/events/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const deleteEvents =
  ...
  async (dispatch) => {
    ...
    try {
      dispatch(loading());
      const { data } = await axios.delete("https://lite-cms-pyfo.onrender.com/api/events", {
        data: { ids },
        headers: {
          Authorization: `Bearer ${token}`,
        },
