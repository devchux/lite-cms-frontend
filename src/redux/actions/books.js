...
export const registerBook = (inputs) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.post(
      "https://lite-cms-pyfo.onrender.com/api/books",
      {
        ...inputs,
      },
      {
  ...
  async (dispatch) => {
    ...
    try {
      ...
      const { data } = await axios.get(
        `https://lite-cms-pyfo.onrender.com/api/books?page=${page}&size=${size}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const getSingleBook = (id) => async (dispatch) => {
  ...
  try {
    dispatch(loading());
    const { data } = await axios.get(`https://lite-cms-pyfo.onrender.com/api/books/${id}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async (dispatch) => {
    ...
    try {
      ...
      const { data } = await axios.delete(
        `https://lite-cms-pyfo.onrender.com/api/books/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const deleteBooks =
  ...
  async (dispatch) => {
    ...
    try {
      dispatch(loading());
      const { data } = await axios.delete("https://lite-cms-pyfo.onrender.com/api/books", {
        data: { ids },
        headers: {
          Authorization: `Bearer ${token}`,
        },
